...
app.initialize();
    function opensite()
    { 
    	 var ref = window.open('http://www.shawacamy.com', '_blank', 'location=yes');
    	    ref.addEventListener('loadstart', function(event) { alert(event.url); });	
    }
    function openmobleapp()
    {
    	 var ref = window.open('http://www.shawacamy.com/mobile-app/advanced-course-detais.php  ', '_blank', 'location=yes');
    	    ref.addEventListener('loadstart', function(event) { alert(event.url); });
    }
    function opengeo()
    {
